// Unique accessory templates
export * from './ringOfOmnipotence'
export * from './amuletOfResurrection'
export * from './charmOfInfiniteFortune'
export * from './bandOfTheArchmage'
...
import { CHARM_OF_INFINITE_FORTUNE } from './charmOfInfiniteFortune'
import { BAND_OF_THE_ARCHMAGE } from './bandOfTheArchmage'
...
export const UNIQUE_ACCESSORIES = [
  ...
  CHARM_OF_INFINITE_FORTUNE,
  BAND_OF_THE_ARCHMAGE,

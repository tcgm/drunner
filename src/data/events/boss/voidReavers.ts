    ...
    },
    {
      ...
      successOutcome: {
        ...
        effects: [
          ...
          { type: 'item', itemType: 'accessory1', minRarity: 'legendary', maxRarity: 'mythic', rarityBoost: 38 },
        ],
      },
      failureOutcome: {
        ...
        effects: [
          ...
          { type: 'item', itemType: 'random', minRarity: 'rare', maxRarity: 'epic', rarityBoost: 22 },
        ],
      },
    },
    {

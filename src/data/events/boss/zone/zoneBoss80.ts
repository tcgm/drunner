  ...
  choices: [
    {
      ...
      outcome: {
        ...
        effects: [
          ...
          { type: 'item', itemType: 'random', minRarity: 'structural', maxRarity: 'singularity', rarityBoost: 35 },
          { type: 'item', itemType: 'random', minRarity: 'structural', maxRarity: 'singularity', rarityBoost: 35 },
          { type: 'item', itemType: 'random', minRarity: 'structural', maxRarity: 'singularity', rarityBoost: 28 },
        ],
      },
    },
    {
      ...
      outcome: {
        ...
        effects: [
          ...
          { type: 'item', itemType: 'random', minRarity: 'structural', maxRarity: 'void', rarityBoost: 45 },
          { type: 'item', itemType: 'random', minRarity: 'structural', maxRarity: 'void', rarityBoost: 40 },
        ],
      },
    },
    {
      ...
      outcome: {
        ...
        effects: [
          ...
          { type: 'item', itemType: 'random', minRarity: 'structural', maxRarity: 'singularity', rarityBoost: 40 },
          { type: 'item', itemType: 'weapon', minRarity: 'structural', maxRarity: 'singularity', rarityBoost: 35 },
        ],
      },
    },
  ],

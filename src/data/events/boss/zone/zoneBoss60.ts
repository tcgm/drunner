  ...
  choices: [
    {
      ...
      outcome: {
        ...
        effects: [
          ...
          { type: 'item', itemType: 'random', minRarity: 'artifact', maxRarity: 'divine', rarityBoost: 25 },
          { type: 'item', itemType: 'random', minRarity: 'artifact', maxRarity: 'divine', rarityBoost: 25 },
        ],
      },
    },
    {
      ...
      successOutcome: {
        ...
        effects: [
          ...
          { type: 'item', itemType: 'random', minRarity: 'artifact', maxRarity: 'divine', rarityBoost: 35 },
          { type: 'item', itemType: 'random', minRarity: 'artifact', maxRarity: 'divine', rarityBoost: 35 },
        ],
      },
      failureOutcome: {
        ...
        effects: [
          { type: 'damage', target: 'all', value: 12, isTrueDamage: true },
          { type: 'xp', value: 1200 },
          { type: 'gold', value: 2000 },
          { type: 'item', itemType: 'random', minRarity: 'mythicc', maxRarity: 'artifact', rarityBoost: 18 },
        ],
      },
    },
    {
      ...
      outcome: {
        ...
        effects: [
          ...
          { type: 'item', itemType: 'random', minRarity: 'artifact', maxRarity: 'divine', rarityBoost: 28 },
          { type: 'item', itemType: 'accessory1', minRarity: 'artifact', maxRarity: 'divine', rarityBoost: 20 },
        ],
      },
    },
  ],

  ...
  choices: [
    {
      ...
      outcome: {
        ...
        effects: [
          ...
          { type: 'item', itemType: 'random', minRarity: 'elder', maxRarity: 'author', rarityBoost: 50 },
          { type: 'item', itemType: 'random', minRarity: 'elder', maxRarity: 'author', rarityBoost: 50 },
          { type: 'item', itemType: 'random', minRarity: 'void', maxRarity: 'author', rarityBoost: 40 },
        ],
      },
    },
    {
      ...
      outcome: {
        ...
        effects: [
          ...
          { type: 'item', itemType: 'weapon', minRarity: 'layer', maxRarity: 'author', rarityBoost: 60 },
          { type: 'item', itemType: 'random', minRarity: 'elder', maxRarity: 'author', rarityBoost: 55 },
          { type: 'item', itemType: 'random', minRarity: 'elder', maxRarity: 'author', rarityBoost: 55 },
        ],
      },
    },
    {
      ...
      outcome: {
        ...
        effects: [
          ...
          { type: 'item', itemType: 'weapon', minRarity: 'layer', maxRarity: 'author', rarityBoost: 65 },
          { type: 'item', itemType: 'armor', minRarity: 'layer', maxRarity: 'author', rarityBoost: 60 },
          { type: 'item', itemType: 'random', minRarity: 'elder', maxRarity: 'author', rarityBoost: 55 },
        ],
      },
    },
    {
      ...
      outcome: {
        ...
        effects: [
          ...
          { type: 'item', itemType: 'weapon', minRarity: 'layer', maxRarity: 'author', rarityBoost: 65 },
          { type: 'item', itemType: 'accessory1', minRarity: 'layer', maxRarity: 'author', rarityBoost: 60 },
        ],
      },
    },
    {
      ...
      outcome: {
        ...
        effects: [
          ...
          { type: 'item', itemType: 'weapon', minRarity: 'layer', maxRarity: 'author', rarityBoost: 62 },
          { type: 'item', itemType: 'accessory1', minRarity: 'layer', maxRarity: 'author', rarityBoost: 58 },
          { type: 'item', itemType: 'random', minRarity: 'elder', maxRarity: 'author', rarityBoost: 55 },
        ],
      },
    },

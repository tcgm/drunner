  ...
  choices: [
    {
      ...
      outcome: {
        ...
        effects: [
          ...
          { type: 'item', itemType: 'random', minRarity: 'void', maxRarity: 'elder', rarityBoost: 40 },
          { type: 'item', itemType: 'random', minRarity: 'singularity', maxRarity: 'void', rarityBoost: 30 },
        ],
      },
    },
    {
      ...
      outcome: {
        ...
        effects: [
          ...
          { type: 'item', itemType: 'random', minRarity: 'void', maxRarity: 'layer', rarityBoost: 50 },
          { type: 'item', itemType: 'armor', minRarity: 'void', maxRarity: 'elder', rarityBoost: 45 },
        ],
      },
    },
    {
      ...
      outcome: {
        ...
        effects: [
          ...
          { type: 'item', itemType: 'weapon', minRarity: 'elder', maxRarity: 'layer', rarityBoost: 50 },
          { type: 'item', itemType: 'accessory1', minRarity: 'void', maxRarity: 'elder', rarityBoost: 45 },
        ],
      },
    },
  ],

  ...
  choices: [
    {
      ...
      outcome: {
        ...
        effects: [
          ...
          { type: 'xp', value: 500 },
          { type: 'gold', value: 800 },
          { type: 'item', itemType: 'random', minRarity: 'magical', maxRarity: 'elite', rarityBoost: 10 },
        ],
      },
    },
    {
      ...
      outcome: {
        ...
        effects: [
          ...
          { type: 'xp', value: 600 },
          { type: 'gold', value: 900 },
          { type: 'item', itemType: 'random', minRarity: 'magical', maxRarity: 'elite', rarityBoost: 12 },
        ],
      },
    },
    {
      ...
      outcome: {
        ...
        effects: [
          ...
          { type: 'item', itemType: 'weapon', minRarity: 'magical', maxRarity: 'elite', rarityBoost: 15 },
        ],
      },
    },
  ],

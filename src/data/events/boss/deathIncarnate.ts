  ...
  choices: [
    {
      ...
      outcome: {
        ...
        effects: [
          ...
          { type: 'item', itemType: 'random', minRarity: 'legendary', maxRarity: 'mythic', rarityBoost: 44 },
        ],
      },
    },
    {
    ...
    },
    {
      ...
      outcome: {
        ...
        effects: [
          ...
          { type: 'item', itemType: 'weapon', minRarity: 'legendary', maxRarity: 'mythic', rarityBoost: 61 },
        ],
      },
    },
  ],
